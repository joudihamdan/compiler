...
hooks:
     ...
     ;
usestate
    : CONST OPENED_SQUERE_BRACES IDENTIFIERNAME COMMA IDENTIFIERNAME CLOSED_SQUERE_BRACES EQUAL USESTATE
     OPENED_BRACES IDENTIFIERNAME  CLOSED_BRACES SEMICOLON
      constfunction
    ;
...
forloop
    : FOR OPENED_BRACES declaration SEMICOLON  operation SEMICOLON (IDENTIFIERNAME PLUS STRING_LITERAL |
    IDENTIFIERNAME MINUS STRING_LITERAL | IDENTIFIERNAME PLUS PLUS
